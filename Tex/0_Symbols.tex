...
In this thesis vectors will be denoted as bold lower case letters $\boldsymbol{x}$, while upper case letters denote matrices $X$. Tensors of dimension at least 3 are written in calligraphic letters, hence $\mathcal{X}^{d_1\times d_2 \times \dots \times d_N}$ is a tensor of order $N$ with elements $x_{i_1, i_2, \dots, i_N}$. A list of symbols used throughout the thesis is given below. 
