...
\end{enumerate}
Some previous approaches will be discussed in the following. In the end, the methods will be compared in terms of their ability to speed-up their given problem or decrease the number of parameters.
