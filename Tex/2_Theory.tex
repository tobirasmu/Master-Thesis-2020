...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Pics/02_Theory/convolution_illustration/convolution_illustration.001.png}
    \caption{Illustration of a simple convolution of a picture with a single input channel. The value $\tensor{Y}($ If there are more input channels, the input image $\tensor{X}$ and the filter $\tensor{K}$ will be 3-dimensional tensors.}
