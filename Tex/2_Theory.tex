...
\begin{equation}
    \tensor{X}(x_1,x_2,x_3) \approx \sum_{i=1}^{n_1} \sum_{j=1}^{n_2} \sum_{l=1}^{n_3} \tensor{G}(i, j, l) \cdot \bs{A}(x_1, i) \cdot \bs{B}(x_2, j) \cdot \bs{C}(x_3, l)
\end{equation}
The concept of Tucker decomposition is shown in XXX. 