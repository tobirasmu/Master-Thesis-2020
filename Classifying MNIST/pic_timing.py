...
NUM_OBS = 100
SAMPLE_SIZE = 100
test = get_variable(Variable(tc.rand((100, 1, 28, 28))))
...
print("The mean time for a 100 forward pushes was {} seconds, while the sum of the layers was {} seconds".format(
    tc.mean(fullTime), tc.sum(layer_time_m)))
...
layer_time_dec_m[0], layer_time_dec_s[0], _ = time_conv(NUM_OBS, (28, 28), 1, r_c1, 5, 2, bias=False, number=SAMPLE_SIZE)
layer_time_dec_m[1], layer_time_dec_s[1], _ = time_conv(NUM_OBS, (28, 28), r_c1, 6, 5, 0, bias=True, number=SAMPLE_SIZE)
layer_time_dec_m[2], layer_time_dec_s[2], _ = time_conv(NUM_OBS, (14, 14), 6, r1_c2, 1, 0, bias=False, number=SAMPLE_SIZE)
layer_time_dec_m[3], layer_time_dec_s[3], _ = time_conv(NUM_OBS, (14, 14), r1_c2, r2_c2, 5, 0, bias=False, number=SAMPLE_SIZE)
layer_time_dec_m[4], layer_time_dec_s[4], _ = time_conv(NUM_OBS, (10, 10), r2_c2, 16, 1, 0, bias=True, number=SAMPLE_SIZE)
